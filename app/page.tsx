...
export default function Home() {
  ...
  for (const [category, items] of Object.entries(starred as Record<string, Array<{ name: string; url: string; description?: string }>>)) {
  ...
  const categorized = mergeRecords(links as Record<string, LinkItem[]>, starredByCategory)
